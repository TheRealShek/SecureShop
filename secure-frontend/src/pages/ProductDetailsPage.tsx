  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <button
              onClick={() => navigate('/products')}
              className="flex items-center text-slate-600 hover:text-slate-900 transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-slate-100"
            >
              <ChevronLeftIcon className="h-5 w-5 mr-2" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 lg:items-start animate-fade-in">
          {/* Image Gallery */}
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <div className="mt-8">
              <div className="flex items-baseline space-x-3">
                ...
                {/* <p className="text-xl text-slate-500 line-through">₹2,999</p> */}
              </div>
              {/* <p className="text-sm text-emerald-600 font-medium">Save ₹500 (17% off)</p> */}
            </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl border border-slate-200">
              <div className="flex items-center space-x-3">
                <div className={`w-3 h-3 rounded-full ${isOutOfStock ? 'bg-red-400' : 'bg-emerald-400'}`}></div>
            ...
            <div className="mt-8 space-y-4">
              <button
                ...
                className={`w-full flex items-center justify-center px-8 py-4 text-base font-semibold rounded-xl transition-all duration-200 transform ${
                  canAddToCart
                    ? 'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
              ...
              <ReviewModal 
                ...
                trigger={
                  <button className="w-full flex items-center justify-center px-8 py-4 text-base font-semibold text-indigo-600 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl hover:bg-gradient-to-r hover:from-indigo-100 hover:to-purple-100 hover:border-indigo-300 transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            ...
            <div className="mt-8 border-t border-slate-200 pt-8">
              <div className="grid grid-cols-1 gap-4 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-slate-900">{product.id.slice(0, 8).toUpperCase()}</span>
                </div>
                <div className="flex justify-between">
